	...
	<div class="container-fluid">
		<div class="card" >
			...
			<div class="card-body" style="padding: 0rem 1rem">
				<form role="form" action="{{ route('event.storeshow') }}" method="POST" enctype="multipart/form-data">
					@csrf
					...
					<div class="form-group">
						...
						<input type="text" name="host_contact" id="host_contact" class="form-control" placeholder="Contact For More Info..." value="{{old('event_date')}}">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="date" name="event_date" id="event_date" class="form-control" min="{{date('Y-m-d')}}">
					</div>
					<div class="form-group">
					...
					<button class="btn btn-success" type="submit">Host Show</button>
				</form>
			</div>
		</div>
	</div>
